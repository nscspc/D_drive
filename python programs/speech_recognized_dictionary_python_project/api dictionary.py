...
def voicedict():
    ...
    with speech_recognition.Microphone() as source:
        ...
        voice.adjust_for_ambient_noise(source,duration=2)#adjust_for_ambient_noise(source,duration=time(in seconds)) function is used to capture the noise using recognizer object through source up to a particular time duration.
